...
// will be established
export const TeamCityWidget = () => (
  <MemoryRouter initialEntries={['/teamcity']}>
    <AppStateProvider>
      <>
        <Routes>
          <Route path="/teamcity" element={<Builds />} />
          <Route path="/teamcity/build/:buildId" element={<BuildWithSteps />} />
        </Routes>
        <Settings />
      </>
    </AppStateProvider>
